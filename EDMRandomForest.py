...
class RandomForestTransportPredictor:
    ...
    def fit_and_optimize(self, x_train, y_train, categorical_features, numerical_features):
        """
...
if __name__ == "__main__":
    ...
    predictor.fit_and_optimize(x_train_data, y_train_data, cat_features, num_features)
