"""
Gaussian Naive Bayes Classifier for Predicting Transportation.

This module implements a Gaussian Naive Bayes classifier using scikit-learn's GaussianNB
...
class GaussianNBTransportPredictor:
    """
    A class to represent a Gaussian Naive Bayes model for predicting transportation.
    ...
    -------
    __init__(self):
        Initializes the GaussianNBTransportPredictor with default values.

    fit(self, x_train, y_train, categorical_features, numerical_features):
        Fits the Gaussian Naive Bayes model to the provided training data.
    ...
    def __init__(self):
        """
        Initializes the GaussianNBTransportPredictor with pipeline and parameter grid.
        """
...
if __name__ == "__main__":
    ...
    cat_features = ['HomePlanet', 'Deck', 'Side', 'Destination', 'CryoSleep', 'VIP']
    num_features = ['Age', 'RoomService', 'FoodCourt', 'ShoppingMall', 'Spa', 'VRDeck', 'Num']

    predictor = GaussianNBTransportPredictor()
